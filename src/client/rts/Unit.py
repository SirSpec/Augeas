...
class Unit(arcade.Sprite):
    ...
    ATTACK_RANGE = 200.
    RED_UNIT_SPRITE_NAME = "unit_red.png"
    BLUE_UNIT_SPRITE_NAME = "unit_blue.png"

    def __init__(self, name: str, filename: str = None, center_x: float = 0, center_y: float = 0) -> None:
        super().__init__(filename=filename, scale=Unit.UNITS_SCALE, center_x=center_x, center_y=center_y)
    ...
    def reached_position(self) -> bool:
        ...
        return abs(self.center_x - self.target_position_x) < ACCEPTABLE_DISTANCE_FROM_TARGET and \
               abs(self.center_y - self.target_position_y) < ACCEPTABLE_DISTANCE_FROM_TARGET
